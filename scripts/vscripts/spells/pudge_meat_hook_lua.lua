...
LinkLuaModifier( "modifier_pudge_meat_hook_followthrough_lua", "modifiers/modifier_pudge_meat_hook_followthrough_lua.lua" ,LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_pudge_meat_hook_lua", "modifiers/modifier_pudge_meat_hook_lua.lua" ,LUA_MODIFIER_MOTION_HORIZONTAL )
...
function pudge_meat_hook_lua:OnSpellStart()
	...
	self:GetCaster():AddNewModifier( self:GetCaster(), self, "modifier_haste_rune", { duration = flFollowthroughDuration } )
