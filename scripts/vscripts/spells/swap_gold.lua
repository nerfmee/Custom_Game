...
function swap_gold:GetAOERadius()
	return self:GetSpecialValueFor( "radius" )
end

--------------------------------------------------------------------------------

function swap_gold:CastFilterResultTarget( hTarget )
...
function swap_gold:GetCustomCastErrorTarget( hTarget )
	if self:GetCaster() == hTarget then
...
function swap_gold:GetCooldown( nLevel )
...
function swap_gold:OnSpellStart()
	...
	local nCasterFX = ParticleManager:CreateParticle( "particles/swap_gold/swap_gold.vpcf", PATTACH_ABSORIGIN_FOLLOW, hCaster )
	...
	local nTargetFX = ParticleManager:CreateParticle( "particles/swap_gold/swap_gold_target.vpcf", PATTACH_ABSORIGIN_FOLLOW, hTarget )
